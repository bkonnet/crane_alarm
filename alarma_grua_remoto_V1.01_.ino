...
// --------------------------------------------------
// OPCION ACTIVA: OLED SPI SSD1309 / SSD1306
// Pantalla 2.42" con pines: GND, VCC, SCK, SDA, RES, DC, CS
// --------------------------------------------------
#include <SPI.h>

#define OLED_SPI_SCK   18
#define OLED_SPI_MOSI  23   // pin SDA de la pantalla
...
// --------------------------------------------------
// OPCION I2C ORIGINAL - dejar comentada
// --------------------------------------------------
...
void setup() {
  ...
  RADIO.begin(9600, SERIAL_8N1, RADIO_RX, RADIO_TX);
    ...
    // OLED SPI
  SPI.begin(OLED_SPI_SCK, -1, OLED_SPI_MOSI, OLED_CS);
  oledOK = display.begin(SSD1306_SWITCHCAPVCC);

  // OLED I2C ORIGINAL - dejar comentado
